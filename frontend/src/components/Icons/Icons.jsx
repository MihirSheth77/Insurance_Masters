 ...
 * Simple SVG icons to avoid Material UI dependencies
 */
...
export const GroupIcon = ({ size = 24, color = 'currentColor' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2">
    ...
    <path d="M3 19v-2c0-2.2 1.8-4 4-4h4c2.2 0 4 1.8 4 4v2" />
    <path d="M15 19v-2c0-1.1.9-2 2-2h2c1.1 0 2 .9 2 2v2" />
  </svg>
);
...
export const PersonIcon = ({ size = 24, color = 'currentColor' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2">
    ...
    <path d="M5 20v-2c0-2.8 2.2-5 5-5h4c2.8 0 5 2.2 5 5v2" />
  </svg>
);

export const ClassIcon = ({ size = 24, color = 'currentColor' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2">
...
export const ReceiptIcon = ({ size = 24, color = 'currentColor' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2">
...
export const ExpandMoreIcon = ({ size = 24, color = 'currentColor' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2">
    <polyline points="6 9 12 15 18 9" />
  </svg>
);

export const ExpandLessIcon = ({ size = 24, color = 'currentColor' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2">
...
export const SettingsIcon = ({ size = 24, color = 'currentColor' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2">
    ...
    <path d="M12 1v6m0 6v6m4.22-10.22l4.24-4.24M6.34 6.34L2.1 2.1m19.9 19.9l-4.24-4.24M6.34 17.66L2.1 21.9" />
  </svg>
);
...
export const AssessmentIcon = ({ size = 24, color = 'currentColor' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2">
...
export const ErrorIcon = ({ size = 24, color = 'currentColor' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2">
    <circle cx="12" cy="12" r="10" />
...
// Additional Icons for Groups page
...
// Additional Icons for Data Management
